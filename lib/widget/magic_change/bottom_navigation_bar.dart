...
enum MyBottomNavigationBarType {
  /// The [MyBottomNavigationBar]'s [BottomNavigationBarItem]s have fixed width.
  fixed,
...
class MyBottomNavigationBar extends StatefulWidget {
  ...
  /// [MyBottomNavigationBarType.fixed] and `false` if [type] is
  ...
  static MyBottomNavigationBarType _type(
    MyBottomNavigationBarType type,
  ...
  static bool _defaultShowUnselected(MyBottomNavigationBarType type) {
    switch (type) {
